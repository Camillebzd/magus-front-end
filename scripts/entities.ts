 ...
 * This data is compatible to be stored or send.
 */
export type SerialisedEntityData = {
  id: number,
  name: string,
  image: string,
  description: string,
...
/**
 * Basic data for all entities. Used to create the entity.
 * Real abilities.
 */
export type EntityData = {
  id: number,   // ID of token or monster 
  uid: string,  // ID of member of UID of monster generated by server
  name: string,
  image: string,
  description: string,
  level: number,
...
/**
 * Entity stats used during a fight.
 */
...
/**
 * Info representing a complete entity.
 */
...
export class Weapon extends Entity {
  ...
  /**
   * Return an object containing all the stats and info about 
   * the weapon
   * @returns an object containing all the data
   */
  getGeneralInfo(): EntityInfo {
    return {
      id: this.id,
      name: this.name,
      image: this.image,
...
export type MonsterUID = string;  // unique id only attached to him (allow to have multiple times the same monster)
export type MonsterID = number;   // id of the monster from DB to represent him
